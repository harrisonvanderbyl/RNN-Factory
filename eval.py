...
MODEL_NAME = "/home/harrison/Documents/RWKV-infctx-trainer/model/RWKV-5-World-1B5-v2-20231025-ctx4096.pth"
    ...
    def _loglikelihood_tokens(self, requests, disable_tqdm=False):
        ...
        for COUNTER in range(len(requests)):
            ...
            if sss in logitBuf:
                ...
                with torch.no_grad():
                    outputs, _ = model.forward(src, state=None, full_output=True)
