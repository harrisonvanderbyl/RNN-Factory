...
class Feed_Forward(nn.Module):
    def __init__(self, args, layer_id):
        ...
        self.key = args.linear(args.n_embd,args.dim_ffn, bias=False, dtype=torch.bfloat16)
        self.receptance = args.linear(args.n_embd, args.n_embd, bias=False, dtype=torch.bfloat16)
